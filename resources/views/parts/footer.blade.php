        ...
        <div class="menu__footer">
            ...
            <div class="copyright">
                ...
                <ul>
                    ...
                    <li>Sede legale: Contrada Colle delle Api, 100/A 86100 - campobasso</li>
                    <li>Pec: lamolisana@pec.it</li>
                    <li>Tel: +3908744981</li>
                    <li>Fax: +390874629584</li>
            ...
            {{-- /copyright --}}
            {{-- navbars --}}
            <div class="footer__navbars">
                {{-- left side --}}
                <div class="footer__navbars__first_half">
                    <nav>
                        <h5>Pastificio</h5>
                        <ul>
